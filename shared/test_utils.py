    ...
    def teardown(self):
        ...
        if self.config.enable_performance_tracking:
            ...
            self.performance_data["memory_delta"] = (
                self.performance_data["end_memory"] - self.performance_data["start_memory"]
            )
    ...
    def create_memory_data(
        ...
        **kwargs
        ...
        return {
            ...
            "metadata": metadata or {"test": "data", "timestamp": datetime.now(UTC).isoformat()},
            "created_at": datetime.now(UTC).isoformat(),
            **kwargs
        }
    ...
    def create_app_data(
        ...
        **kwargs
        ...
        return {
            ...
            "description": description or f"Test application {DataFactory.random_string()}",
            "is_active": True,
            "created_at": datetime.now(UTC).isoformat(),
            **kwargs
        }
