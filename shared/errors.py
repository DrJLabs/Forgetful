...
class NotFoundError(StructuredError):
    ...
    def __init__(self, message: str, resource_type: str = None, resource_id: str = None, **kwargs):
        super().__init__(
            ...
            technical_details={'resource_type': resource_type, 'resource_id': resource_id},
            recovery_strategy=ErrorRecovery.IGNORE,
            **kwargs
        )
    ...
    def analyze_error_patterns(errors: List[StructuredError]) -> Dict[str, Any]:
        ...
        for error in errors:
            if error.recovery_strategy:
                ...
                analysis['by_recovery_strategy'][strategy] = analysis['by_recovery_strategy'].get(strategy, 0) + 1
        
        # Most common error codes
        for error in errors:
            code = error.error_code
            analysis['most_common_errors'][code] = analysis['most_common_errors'].get(code, 0) + 1
