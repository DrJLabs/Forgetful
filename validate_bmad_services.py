    ...
    def validate_context7(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return (
                    False,
                    f"❌ Context7 MCP server returned status {response.status_code}",
                )
        except requests.exceptions.ConnectionError:
            return (
                False,
                f"❌ Context7 MCP server not accessible at {self.context7_url}",
            )
        except requests.exceptions.Timeout:
    ...
    def validate_all_services(self) -> Dict[str, Dict[str, any]]:
        ...
        results["overall"] = {
            ...
            "message": (
                ...
                if mem0_valid and context7_valid
                else "❌ Some services not accessible"
            ),
        }
