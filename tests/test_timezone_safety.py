...
class TestTimezoneSafety:
    ...
    def test_problematic_patterns_resolved(self):
        ...
        try:
            ...
            pytest.fail(
                "safe_datetime_now should not raise TypeError with naive datetime"
            )
        ...
        try:
            ...
            pytest.fail(
                "safe_datetime_diff should not raise TypeError with mixed types"
            )
    ...
    def test_metadata_simulation(self):
        ...
        last_time = datetime.fromisoformat(
            metadata_mixed["last_accessed"].replace("Z", "+00:00")
        )
...
class TestRegression:
    ...
    def test_confidence_scoring_recency_boost(self):
        ...
        try:
            ...
            pytest.fail(
                "_calculate_recency_boost should not raise TypeError with naive datetime"
            )
    ...
    def test_confidence_scoring_temporal_relevance(self):
        ...
        try:
            ...
            pytest.fail(
                "_calculate_temporal_relevance should not raise TypeError with naive datetime"
            )
    ...
    def test_context_aware_scorer_penalize_outdated(self):
        ...
        # This should not raise TypeError
        try:
            result = scorer._apply_context_adjustments(
                base_confidence, metadata, profile
            )
            assert isinstance(result, float)
        except TypeError:
            pytest.fail(
                "_apply_context_adjustments should not raise TypeError with naive datetime"
            )
