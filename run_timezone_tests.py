...
def run_tests():
    ...
    test_commands = [
        {
            ...
            "cmd": [
                ...
                "-m",
                "pytest",
                "tests/test_storage_optimization_timezone.py::TestTimezoneEdgeCases",
                "-v",
                "--tb=short",
            ],
            "critical": True,
        },
        {
            ...
            "cmd": [
                ...
                "-m",
                "pytest",
                "tests/test_storage_optimization_timezone.py::TestStorageOptimizationIntegration",
                "-v",
                "--tb=short",
            ],
            "critical": True,
        },
        {
            ...
            "cmd": [
                ...
                "-m",
                "pytest",
                "tests/test_storage_optimization_timezone.py::TestTimezoneRegressionTests",
                "-v",
                "--tb=short",
            ],
            "critical": True,
        },
        {
            ...
            "cmd": [
                ...
                "-m",
                "pytest",
                "tests/test_storage_optimization_timezone.py::TestPerformanceRegression",
                "-v",
                "--tb=short",
                "-m",
                "performance",
        ...
        },
        {
            ...
            "cmd": [
                ...
                "-m",
                "pytest",
                "tests/test_storage_optimization_timezone.py",
                "--cov=mem0.memory.storage_optimization",
    ...
    critical_failures = sum(
        1 for _, status, critical in results if status == "FAILED" and critical
    )
    ...
    if critical_failures > 0:
        ...
        print(
            "❌ Timezone fixes have critical issues that must be addressed before deployment."
        )
        return False
    elif failed_count > 0:
        print(f"\n⚠️  NON-CRITICAL FAILURES: {failed_count}")
        print(
            "✅ Core timezone functionality is working, but some optional tests failed."
        )
        return True
    else:
        print("\n🎉 ALL TESTS PASSED!")
...
def check_dependencies():
    ...
    required_packages = ["pytest", "freezegun", "pytest-cov"]
