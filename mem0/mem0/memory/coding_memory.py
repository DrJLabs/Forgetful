...
class CodingMemory(Memory):
    ...
    def _add_to_vector_store(self, messages, metadata, filters, infer):
        ...
        system_prompt = self.coding_config.coding_fact_extraction_prompt or self.fact_extractor.get_coding_fact_extraction_prompt()
        user_prompt = f"Input:\n{parsed_messages}"
    ...
    def _process_coding_facts(self, facts: List[str], metadata: Dict[str, Any], filters: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    def _rank_coding_results(self, results: List[Dict[str, Any]], query: str, coding_context: Optional[str]) -> List[Dict[str, Any]]:
        """
    ...
    def test_deduplication_performance(self, test_facts: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if results['total_tested'] > 0:
            results['accuracy'] = (results['total_tested'] - 
