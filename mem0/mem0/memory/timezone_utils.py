...
def safe_datetime_diff(dt1: datetime, dt2: datetime) -> timedelta:
    ...
    try:
        ...
        dt1_naive = datetime(dt1.year, dt1.month, dt1.day, dt1.hour, dt1.minute, dt1.second, dt1.microsecond)
        dt2_naive = datetime(dt2.year, dt2.month, dt2.day, dt2.hour, dt2.minute, dt2.second, dt2.microsecond)
