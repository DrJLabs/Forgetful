...
class HierarchicalCategorizer:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.category_hierarchy = {
            'development': {
                'code_implementation': ['functions', 'classes', 'modules', 'algorithms'],
                'architecture': ['patterns', 'design', 'structure', 'frameworks'],
                'testing': ['unit_tests', 'integration_tests', 'e2e_tests', 'test_strategies'],
                'refactoring': ['code_cleanup', 'optimization', 'restructuring', 'modernization']
            },
            'troubleshooting': {
                'bug_fix': ['syntax_errors', 'logic_errors', 'runtime_errors', 'edge_cases'],
            ...
            'operations': {
                'deployment': ['ci_cd', 'containerization', 'orchestration', 'environments'],
                'configuration': ['settings', 'environment_vars', 'parameters', 'secrets'],
    ...
    def _get_sub_category_patterns(self, sub_category: str) -> List[str]:
        ...
        patterns = {
            ...
            'algorithms': [r'\balgorithm\b', r'\bsort\b', r'\bsearch\b', r'\boptimize\b'],
            'patterns': [r'\bpattern\b', r'\bsingleton\b', r'\bfactory\b', r'\bobserver\b'],
            ...
            'syntax_errors': [r'\bsyntax\s+error\b', r'\bindentation\b', r'\bparsing\b'],
            ...
            'best_practices': [r'\bbest\s+practice\b', r'\bconvention\b', r'\bstandard\b']
        }
    ...
    def get_category_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            } if total_categorizations > 0 else {},
            'hierarchy_structure': self.category_hierarchy,
            'average_confidence': sum(
                h['confidence'] for h in self.categorization_history
            ) / len(self.categorization_history) if self.categorization_history else 0.0
        }
