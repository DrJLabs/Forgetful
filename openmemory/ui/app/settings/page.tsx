  ...
  return (
    <div className='text-white py-6'>
      <div className='container mx-auto py-10 max-w-4xl'>
        <div className='flex justify-between items-center mb-8'>
          <div className='animate-fade-slide-down'>
            ...
            <p className='text-muted-foreground mt-1'>
              Manage your OpenMemory and Mem0 configuration
            </p>
          </div>
          <div className='flex space-x-2'>
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  variant='outline'
                  className='border-zinc-800 text-zinc-200 hover:bg-zinc-700 hover:text-zinc-50 animate-fade-slide-down'
                  disabled={isLoading}
                >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will reset all settings to the system defaults. Any
                    custom configuration will be lost. API keys will be set to
            ...
            <Button
              onClick={handleSave}
              className='bg-primary hover:bg-primary/90 animate-fade-slide-down'
              disabled={isLoading}
            >
        ...
        <Tabs
          value={viewMode}
          onValueChange={(value) => setViewMode(value as 'form' | 'json')}
          className='w-full animate-fade-slide-down delay-1'
        >
