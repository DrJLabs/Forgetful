...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_access_controls_created_at"),
        "access_controls",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_access_controls_effect"), "access_controls", ["effect"], unique=False
    )
    op.create_index(
        op.f("ix_access_controls_object_id"),
        "access_controls",
        ["object_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_access_controls_object_type"),
        "access_controls",
        ["object_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_access_controls_subject_id"),
        "access_controls",
        ["subject_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_access_controls_subject_type"),
        "access_controls",
        ["subject_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_archive_policies_created_at"),
        "archive_policies",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_archive_policies_criteria_id"),
        "archive_policies",
        ["criteria_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_archive_policies_criteria_type"),
        "archive_policies",
        ["criteria_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "state",
            sa.Enum("active", "paused", "archived", "deleted", name="memorystate"),
            nullable=True,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        "idx_memory_app_state", "memories", ["app_id", "state"], unique=False
    )
    op.create_index(
        "idx_memory_user_app", "memories", ["user_id", "app_id"], unique=False
    )
    op.create_index(
        "idx_memory_user_state", "memories", ["user_id", "state"], unique=False
    )
    op.create_index(op.f("ix_memories_app_id"), "memories", ["app_id"], unique=False)
    op.create_index(
        op.f("ix_memories_archived_at"), "memories", ["archived_at"], unique=False
    )
    op.create_index(
        op.f("ix_memories_created_at"), "memories", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_memories_deleted_at"), "memories", ["deleted_at"], unique=False
    )
    ...
    op.create_index(
        "idx_access_memory_time",
        "memory_access_logs",
        ["memory_id", "accessed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_access_logs_access_type"),
        "memory_access_logs",
        ["access_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_access_logs_accessed_at"),
        "memory_access_logs",
        ["accessed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_access_logs_app_id"),
        "memory_access_logs",
        ["app_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_memory_categories_category_id"),
        "memory_categories",
        ["category_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_categories_memory_id"),
        "memory_categories",
        ["memory_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_memory_status_history_changed_at"),
        "memory_status_history",
        ["changed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_status_history_changed_by"),
        "memory_status_history",
        ["changed_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_status_history_memory_id"),
        "memory_status_history",
        ["memory_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_status_history_new_state"),
        "memory_status_history",
        ["new_state"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_status_history_old_state"),
        "memory_status_history",
        ["old_state"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_memory_status_history_old_state"), table_name="memory_status_history"
    )
    op.drop_index(
        op.f("ix_memory_status_history_new_state"), table_name="memory_status_history"
    )
    op.drop_index(
        op.f("ix_memory_status_history_memory_id"), table_name="memory_status_history"
    )
    op.drop_index(
        op.f("ix_memory_status_history_changed_by"), table_name="memory_status_history"
    )
    op.drop_index(
        op.f("ix_memory_status_history_changed_at"), table_name="memory_status_history"
    )
    ...
    op.drop_index(
        op.f("ix_memory_categories_memory_id"), table_name="memory_categories"
    )
    op.drop_index(
        op.f("ix_memory_categories_category_id"), table_name="memory_categories"
    )
    op.drop_index("idx_memory_category", table_name="memory_categories")
    op.drop_table("memory_categories")
    op.drop_index(
        op.f("ix_memory_access_logs_memory_id"), table_name="memory_access_logs"
    )
    op.drop_index(op.f("ix_memory_access_logs_app_id"), table_name="memory_access_logs")
    op.drop_index(
        op.f("ix_memory_access_logs_accessed_at"), table_name="memory_access_logs"
    )
    op.drop_index(
        op.f("ix_memory_access_logs_access_type"), table_name="memory_access_logs"
    )
    ...
    op.drop_index(
        op.f("ix_archive_policies_criteria_type"), table_name="archive_policies"
    )
    op.drop_index(
        op.f("ix_archive_policies_criteria_id"), table_name="archive_policies"
    )
