...
from app.schemas import (
    MemoryResponse, PaginatedMemoryResponse, MemoryCreate, MemoryUpdate
)
from app.routers.mem0_memories import CreateMemoryRequest, MemoryResponse as Mem0MemoryResponse
...
class TestContentTypeValidation(TestAPIContractValidation):
    ...
    def test_json_content_type_requirement(self, client):
        ...
        assert response.status_code == status.HTTP_415_UNSUPPORTED_MEDIA_TYPE or \
