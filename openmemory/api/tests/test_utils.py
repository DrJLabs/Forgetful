...
class TestPermissionUtils:
    ...
    def test_check_memory_access_permissions_allowed(self, test_db_session, test_user, test_app, test_memory):
        """Test memory access permission when allowed"""
        # Test with matching app_id
        has_access = check_memory_access_permissions(test_db_session, test_memory, test_app.id)
        assert has_access is True
    
    def test_check_memory_access_permissions_denied(self, test_db_session, test_user, test_app, test_memory):
        ...
        has_access = check_memory_access_permissions(test_db_session, test_memory, other_app.id)
        assert has_access is False
    
    def test_check_memory_access_permissions_no_app_filter(self, test_db_session, test_user, test_app, test_memory):
