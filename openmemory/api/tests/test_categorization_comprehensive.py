...
from app.utils.categorization import get_categories_for_memory, MemoryCategories
...
class TestCategoryGeneration:
    ...
    def test_get_categories_for_memory_success(self):
        ...
        memory_text = "I went to the grocery store and bought apples, bananas, and bread."
    ...
    def test_get_categories_for_memory_special_characters(self):
        ...
        memory_text = "I bought groceries: apples, bananas, & bread @ the store! Cost: $25.50"
...
class TestRetryMechanism:
    ...
    def test_exponential_backoff_behavior(self):
        ...
        with patch('app.utils.categorization.openai_client') as mock_client:
            mock_client.beta.chat.completions.parse.side_effect = Exception("API rate limit")
...
class TestCategoryValidation:
    ...
    def test_category_length_validation(self):
        ...
        categories_response = ["a", "valid_category", "x" * 100]  # Too short and too long
...
class TestPerformanceAndTimeout:
    ...
    def test_api_timeout_handling(self):
        ...
        with patch('app.utils.categorization.openai_client') as mock_client:
            mock_client.beta.chat.completions.parse.side_effect = TimeoutError("API timeout")
