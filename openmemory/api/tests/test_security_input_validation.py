...
class TestSQLInjectionPrevention:
    ...
    @pytest.mark.asyncio
    async def test_search_query_sql_injection(self, test_client: AsyncClient, test_user):
...
class TestXSSPrevention:
    ...
    @pytest.mark.asyncio
    async def test_search_query_xss_prevention(self, test_client: AsyncClient, test_user):
...
class TestParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_pagination_parameter_validation(self, test_client: AsyncClient, test_user):
        ...
        for params in invalid_pagination_params:
            response = await test_client.get(
                "/api/v1/memories/",
                params={"user_id": test_user.user_id, **params}
            )
