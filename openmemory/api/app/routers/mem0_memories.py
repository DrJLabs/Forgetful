    ...
    try:
        ...
        if search_query:
            ...
            results = memory_client.search(
                query=search_query, user_id=user_id, limit=size
            )
        ...
        return PaginatedMemoryResponse(items=[], total=0, page=page, size=size, pages=0)
...
async def create_memory(request: CreateMemoryRequest):
    ...
    try:
        ...
        # Add to mem0
        result = memory_client.add(messages, user_id=request.user_id, metadata=metadata)
...
async def get_memory(memory_id: str):
    ...
    try:
        ...
        return {
            ...
            "text": memory.get(
                "memory", ""
            ),  # Also include as 'text' for compatibility
